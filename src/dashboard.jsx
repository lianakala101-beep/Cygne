      ...
      {products.length > 0 && (
        ...
        <div style={{ display: "flex", gap: 10, marginBottom: 20 }}>
          ...
          <button onClick={() => setFlightOpen(true)}
            ...
            <div>
              <p style={{ fontFamily: "var(--font-body), sans-serif", fontSize: 10, color: "rgba(232,227,214,0.95)", fontWeight: 400, margin: "0 0 2px", letterSpacing: "0.06em", textTransform: "uppercase" }}>Travel Edit</p>
          ...
          <button onClick={() => setShopScanOpen(true)}
            ...
            <div>
              <p style={{ fontFamily: "var(--font-body), sans-serif", fontSize: 10, color: "rgba(232,227,214,0.95)", fontWeight: 400, margin: "0 0 2px", letterSpacing: "0.06em", textTransform: "uppercase" }}>Shop Scan</p>
              <p style={{ fontFamily: "var(--font-body), sans-serif", fontSize: 9, color: "rgba(232,227,214,0.45)", margin: 0, letterSpacing: "0.02em" }}>Would my skin like this?</p>
            </div>
          </button>
        </div>
