    ...
    try {
      ...
      const resp = await fetch("https://mxcefgbaaylddnyxrnao.supabase.co/functions/v1/rapid-action", {
        ...
        body: JSON.stringify({ model: "claude-sonnet-4-20250514", max_tokens: 1500, messages: [{ role: "user", content: [
          ...
          { type: "text", text: "You are a skincare product analyst with expertise in Korean (K-beauty), Japanese (J-beauty), Western, and indie skincare brands. Identify the product from this image — including Korean brands (e.g., COSRX, Beauty of Joseon, Anua, Some By Mi, Isntree, Innisfree, Laneige, Sulwhasoo, Missha, Etude House, Tirtir, Torriden, Mixsoon, Haruharu Wonder, Round Lab, Skin1004, Klairs, Purito, Iunik, Abib, Axis-Y, By Wishtrend, Medicube, Numbuzin, Rovectin, Pyunkang Yul, Dr. Ceuracle, Dr. Jart, I'm From, Benton, Sioris, Ma:nyo, Hanyul, Sum37, Belif, Neogen, Mediheal) and Korean product lines. Read any Korean (Hangul), Japanese, or English text on the packaging. Return ONLY a JSON object with these exact fields: brand (string), name (string), category (one of: Cleanser/Toner/Essence/Serum/Ampoule/Eye Cream/Moisturizer/SPF/Oil/Exfoliant/Mask/Sleeping Mask/Sheet Mask/Treatment/Mist/Lip Care), ingredients (comma-separated string of all visible ingredients, translated to English INCI names where possible — include Korean actives like Centella Asiatica, Snail Secretion Filtrate, Propolis, Rice Extract, Ginseng, Mugwort/Artemisia, Heartleaf/Houttuynia, Niacinamide, Madecassoside, Beta-Glucan, Bifida Ferment Lysate). No markdown, no explanation, just the JSON object." }
        ]}] })
      });
