    ...
    <div style={{ marginBottom: 20 }}>
      ...
      <button onClick={() => setExpanded(e => !e)}
        ...
        <div style={{ flex: 1, display: "flex", alignItems: "center", gap: 6 }}>
          <span style={{ fontFamily: "var(--font-display)", fontWeight: 400, fontSize: 10, letterSpacing: "0.12em", color: "var(--color-inky-moss)" }}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 14 }}>
          {env.humidity !== null && (
            <div style={{ display: "flex", alignItems: "center", gap: 4 }}>
              ...
              <span style={{ fontFamily: "var(--font-display)", fontWeight: 400, fontSize: 10, letterSpacing: "0.12em", color: "var(--color-inky-moss)" }}>{env.humidity}%</span>
            </div>
          )}
          {env.uvIndex !== null && (
            <div style={{ display: "flex", alignItems: "center", gap: 4 }}>
              <span style={{ color: "var(--clay)", opacity: 0.5, display: "inline-flex" }}><Icon name="sun" size={10} /></span>
              <span style={{ fontFamily: "var(--font-display)", fontWeight: 400, fontSize: 10, letterSpacing: "0.12em", color: "var(--color-inky-moss)" }}>UV {env.uvIndex}</span>
            </div>
          )}
          {env.temp !== null && (
            <div style={{ display: "flex", alignItems: "center", gap: 4 }}>
              <span style={{ fontFamily: "var(--font-display)", fontWeight: 400, fontSize: 10, letterSpacing: "0.12em", color: "var(--color-inky-moss)" }}>{Math.round(tempUnit === "F" ? (env.temp * 9/5 + 32) : env.temp)}°{tempUnit}</span>
            </div>
          )}
          {nudges.length > 0 && (
